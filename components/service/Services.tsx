...
const servicesData = [
  ...
  },
  {
    ...
    title: "IT Support",
    description:
      "I provide reliable IT support services, resolving technical issues, optimizing systems, and ensuring smooth operation of your IT infrastructure to keep your business running efficiently.",
  },
  {
    icon: <Cloud size={72} strokeWidth={0.8} />,
    title: "Cloud Engineering and Consultation",
    description:
      "I design, implement, and optimize cloud solutions tailored to your business needs, providing expert consultation to ensure scalability, security, and cost-efficiency across cloud environments.",
  },
  {
