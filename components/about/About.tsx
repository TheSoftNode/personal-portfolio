...
const About = (props: Props) => {
  ...
  return (
    <section id="about" className="xl:min-h-[860px] dark:pt-10 pb-10 xl:py-24 md:px-10 px-3 overflow-hidden relative">
            ...
            <Tabs defaultValue="personal">
              ...
              <div className="text-lg mt-12 xl:mt-8">
                        ...
                        <div className="flex flex-col gap-y-6 relative">
                          <Tabs defaultValue="experiences">
                            ...
                            <TabsContent value="Responsibilities">
                              <div className="relative overflow-hidden min-h-[400px] bg-background/50">
                                <Experience />
                              </div>
                            </TabsContent>
                          </Tabs>
                ...
                <TabsContent value="pitch">
                  <div className="text-center xl:text-left">
                    <h3 className="h3 mb-8">My Pitch</h3>
                    <p className="subtitle max-w-xl mx-auto xl:mx-0">
                      Add your pitch content here...
                    </p>
                  </div>
                </TabsContent>
              </div>
