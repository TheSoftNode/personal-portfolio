            ...
            {visible ? (
                ...
                >
                    {navItems.map((navItem: any, idx: number) => (
                        ...
                        >
                            <span
                                className={`${navItem.link === path && "!text-[#FE6E58]"} dark:text-white block sm:hidden text-black-100`}
                            >
                                {navItem.icon}
                            </span>

                            <span
                                className={`${navItem.link === path && "!text-[#FE6E58]"} hidden hover:text-[#FE6E58] dark:hover:text-[#FE6E58] sm:block font-medium text-md text-black-100 dark:text-white`}
                            >
                                {navItem.name}
                            </span>
                        </Link>
