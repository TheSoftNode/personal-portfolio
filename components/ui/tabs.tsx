...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex  items-center justify-center xl:bg-white rounded-[30px]  p-1 text-muted-foreground dark:md:bg-[#212131]",
      // dark:md:bg-[#212131]",
      className
    )}
    {...props}
