...
const ReviewText = ({ reviewText, reviewId }: ReviewProps) =>
{
    ...
    return (
        <CardDescription className="text-md xlg:text-lg text-muted-foreground prose text-justify leading-relaxed tracking-tighter sm:tracking-tight word-spacing">
            {isTruncated ? (
                <>
                    {truncatedText}...{" "}
